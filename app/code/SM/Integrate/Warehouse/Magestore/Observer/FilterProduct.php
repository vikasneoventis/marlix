...
namespace SM\Integrate\Warehouse\Magestore\Observer;
...
class FilterProduct implements ObserverInterface {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        ...
        $this->warehouseIntegrateManagement->getCurrentIntegrateModel()->filterProductCollectionByWarehouse($collection, $warehouseId);
    }
}