 ...
 */
namespace Yosto\ImageProductSlide\Block\Product;

use Yosto\ImageProductSlide\Model\GalleryFactory;
use Yosto\ImageProductSlide\Model\GalleryValueFactory;
use Magento\Catalog\Model\Product\Gallery;
...
class AbstractProduct extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var GalleryValueFactory
     */
    protected $_galleryValueFactory;
     ...
     * @param GalleryValueFactory $galleryValueFactory
    ...
    public function __construct(
        ...
        GalleryValueFactory $galleryValueFactory,
        ...
        $this->_galleryValueFactory = $galleryValueFactory;
     ...
     *
     * Some objects can use setSubmitRouteData() 
	 * to set route and params for form submitting,
    ...
    public function hasProductUrl($product)
    {
        ...
        if ($product->hasUrlDataObject()) {
            if (in_array($product->hasUrlDataObject()
                ->getVisibility(), $product->getVisibleInSiteVisibilities())) {
                return true;
            }
        }
     ...
     * @return array
     */
    public function getGalleryImages($entityId)
    {
        $galleries = $this->_galleryFactory->create()->getCollection();
        $galleryValues = $this->_galleryValueFactory->create()->getCollection();
        $galleries->getSelect()->join
        (
            $galleryValues->getMainTable(),
            'main_table.value_id = '.$galleryValues->getMainTable().'.value_id'
        );
        $gallerieArr = $galleries->addFieldToFilter
        (
            $galleryValues->getMainTable().'.disabled',
            array('eq'=>'0')
        )->addFieldToFilter(
            $galleryValues->getMainTable().'.entity_id',
            array('eq'=>$entityId)
        );
        return $gallerieArr;
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/animation_speed'
            , $this->_storeScope);
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/slideshow_speed'
            , $this->_storeScope);
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/direction'
            , $this->_storeScope);
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/reverse'
            , $this->_storeScope);
    }
     ...
     * @return mixed
     */
    public function getPauseOnAction()
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/pause_on_action'
            , $this->_storeScope);
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/pause_on_hover'
            , $this->_storeScope);
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/randomize'
            , $this->_storeScope);
    }
    /**
     * @return mixed
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/animation_type'
            , $this->_storeScope);
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'product_slide_image/product_slide/enable'
            , $this->_storeScope);
    }
}
