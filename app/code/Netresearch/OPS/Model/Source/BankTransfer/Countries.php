...
namespace Netresearch\OPS\Model\Source\BankTransfer;
...
class Countries
{
    ...
    {
        if (!$this->options) {
            $this->options = $this->countryCollection->load()->toOptionArray(false);
            if (!$isMultiselect) {
            ...
            $this->options['*'] = ['value'=>'*', 'label'=> __('Miscellaneous Countries')];
        }
