...
class Pmlist
{
    ...
    public function toOptionArray()
    {
        return [
            [
                'value' => \Netresearch\OPS\Model\Payment\PaymentAbstract::PMLIST_HORIZONTAL_LEFT,
                'label' => __('Horizontally grouped logo with group name on left')
            ],
            [
                'value' => \Netresearch\OPS\Model\Payment\PaymentAbstract::PMLIST_HORIZONTAL,
                'label' => __('Horizontally grouped logo with no group name')
            ],
            [
                'value' => \Netresearch\OPS\Model\Payment\PaymentAbstract::PMLIST_VERTICAL,
                'label' => __('Verical list')
            ]
        ];
    }
}
