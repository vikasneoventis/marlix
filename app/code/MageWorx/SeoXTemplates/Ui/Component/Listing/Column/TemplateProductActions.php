...
class TemplateProductActions extends \MageWorx\SeoXTemplates\Ui\Component\Listing\Column\TemplateActions
{
    ...
    {
        return __('Are you sure you wan\'t to apply the Product Template "${ $.$data.name }" ? This action cannot be canceled.');
    }
    ...
    {
        return __('Are you sure you wan\'t to delete the Product Template "${ $.$data.name }" ?');
    }
}
