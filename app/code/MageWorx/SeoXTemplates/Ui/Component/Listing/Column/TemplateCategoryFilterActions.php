...
class TemplateCategoryFilterActions extends \MageWorx\SeoXTemplates\Ui\Component\Listing\Column\TemplateActions
{
    ...
    {
        return __('Are you sure you wan\'t to apply the Category Filter Template "${ $.$data.name }" ? This action cannot be canceled.');
    }
    ...
    {
        return __('Are you sure you wan\'t to delete the Category Filter Template "${ $.$data.name }" ?');
    }
}
