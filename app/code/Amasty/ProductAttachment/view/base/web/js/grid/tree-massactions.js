...
define([
    'ko',
    'underscore',
    'Amasty_ProductAttachment/js/grid/massactions'
], function (ko, _, Massactions) {
    'use strict';

    return Massactions.extend({
        defaults: {
            template: 'Amasty_ProductAttachment/grid/tree-massactions',
            submenuTemplate: 'ui/grid/submenu',
            amastysubmenuTemplate: 'Amasty_ProductAttachment/grid/submenu',
            selectProvider: '',
            modules: {
